		...
		<div class="container">
			<div class="intro">
				<img class="intro-img img-fluid mb-3 mb-lg-0 rounded"
					src="img/modifier.jpg" alt="" />
				<div class="intro-text left-0 text-center bg-faded p-5 rounded">
					<h2 class="section-heading mb-4">
						<span class="section-heading-upper">Modification(s)</span> <span
							class="section-heading-lower">Informations</span>
					</h2>
					<%
						if (session.getAttribute("message").equals("succesModif")) {
					%>
					<p>Vos modifications ont bien été prises en compte!</p>
					<%
						} else if (session.getAttribute("message").equals("succesAjout")) {
					%>
					<p>Votre ville a bien été ajoutée!</p>
					<%
						}else if (session.getAttribute("message").equals("SuccesSuppr")) {
					%>
					<p>Votre ville a bien été supprimée!</p>
					<%}%>
					<div>
						<form action=UtilisationVille method="get">
							<input type="submit" class="btn btn-primary btn-xl"
								value="Retour à la gestion des villes" />
						</form>
					</div>

					<div class="intro-button mx-auto">
						<a class="btn btn-primary btn-xl" href="index.html">Retour à
							l'accueil</a>
					</div>
				</div>
			</div>
