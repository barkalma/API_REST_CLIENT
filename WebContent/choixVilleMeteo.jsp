				...
				<div class="intro-text left-0 text-center bg-faded p-5 rounded">
					<h2 class="section-heading mb-4">
						<span class="section-heading-upper">Ville de France</span> <span
							class="section-heading-lower">Choisir une ville pour voir la meteo</span>
					</h2>
					<%!List<VilleBuilder> ville;%>
					<form action="AfficheMeteo" method="get">
						<div class="form-group text-left">
							<label for="nom">Ville :</label> <SELECT name="ville">
