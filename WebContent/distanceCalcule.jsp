			...
			<div class="intro">
				...
				<div class="intro-text left-0 text-center bg-faded p-5 rounded">
					<h2 class="section-heading mb-4">
						<span class="section-heading-upper">Distance</span> <span
							class="section-heading-lower">Distance calculée :</span>
					</h2>
					<p>
						La distance entre
					...
					<div>
						<form action="ListeVille" method="get">
							<input type="submit" class="btn btn-primary btn-xl"
								value="Calculer une autre distance" />
						</form>
					</div>
